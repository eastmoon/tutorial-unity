...
{ 
    public class Wheel : MonoBehaviour {
        ...
        {
            "Goods/icon_resource_1",
            "Goods/icon_resource_2",
            "Goods/icon_resource_3",
            "Goods/icon_specialty_1",
            "Goods/icon_specialty_2",
            "Goods/icon_specialty_3",
            "Goods/icon_product_1",
            "Goods/icon_product_2",
            "Goods/icon_product_3"
        };
